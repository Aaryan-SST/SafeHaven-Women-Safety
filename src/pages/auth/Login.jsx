...
export default function Login() {
  ...
  const { login, loginWithGoogle, getRoleHome } = useAuth()
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      navigate(from || getRoleHome(), { replace: true })
    } catch (err) {
    ...
    <div className="min-h-screen bg-gradient-to-br from-rose-50 via-white to-pink-50 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-500 dark:text-gray-400 mt-1">Sign in to your SafeHaven account</p>
        </div>
